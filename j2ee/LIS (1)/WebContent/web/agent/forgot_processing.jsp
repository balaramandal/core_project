...
<%
    ...
    msg = msg+"<form action='http://localhost:8084/LifeInsurance/agent/recover_password.jsp'><input type='hidden' name='email' value="+email+"><input style='width:200px;height:35px;background:#0099FF;color:#FFFFFF;font-size:16px;' type='submit' value='Verify Your Email'><br></form>";
    ...
    if("Success".equals(status))
    {
        ...
        response.sendRedirect("AgentLogin.jsp?msg="+msg1);
    }
    else
    {
